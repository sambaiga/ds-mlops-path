...
![The relationship between AI, ML, Data Science, and MLOps. ML sits inside the AI hierarchy; Data Science uses ML as one of its tools; MLOps is the engineering layer below both that takes trained models to production.](04-ml-intro/figs/ai-ml-ds-hierarchy.svg){fig-alt="Nested ovals showing AI as the outermost boundary, Machine Learning inside it, Deep Learning inside ML. Data Science overlaps with the ML oval. An MLOps box sits below, connected by an arrow, labelled: takes models to production."}
