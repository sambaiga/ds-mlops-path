...
<span style="color:#0369A1;font-weight:bold"><i class="bi bi-info-circle-fill"></i> Key Concept: <code>pre-commit install</code> must run after every clone</span><br><br>
...
<span style="color:#065F46;font-weight:bold"><i class="bi bi-puzzle-fill"></i> Activity 1 - First Hook Run</span><br><br>
...
<pre style='background:#FFF8E1;padding:10px;border-radius:4px;font-size:0.9em'>uv run pre-commit install
...
<span style="color:#059669;font-weight:bold"><i class="bi bi-journal-code"></i> Example: Before and after nbstripout</span><br><br>
...
<div style="background:#EBF5F0;border-left:5px solid #009E73;padding:14px 18px;border-radius:6px;margin:16px 0">
<span style="color:#065F46;font-weight:bold"><i class="bi bi-puzzle-fill"></i> Activity 2 - Clean Notebook Diffs</span><br><br>
...
<pre style='background:#FFF8E1;padding:10px;border-radius:4px;font-size:0.9em'>git add notebooks/analysis.ipynb
...
<span style="color:#5B21B6;font-weight:bold"><i class="bi bi-lightbulb-fill"></i> Pro Tip: <code>cz bump</code> replaces manual version management</span><br><br>
...
<div style="background:#EBF5F0;border-left:5px solid #009E73;padding:14px 18px;border-radius:6px;margin:16px 0">
<span style="color:#065F46;font-weight:bold"><i class="bi bi-puzzle-fill"></i> Activity 3 - Commitizen in Action</span><br><br>
...
<pre style='background:#FFF8E1;padding:10px;border-radius:4px;font-size:0.9em'>git commit -m "update stuff"              # should fail
...
<span style="color:#991B1B;font-weight:bold"><i class="bi bi-bug-fill"></i> Common Mistake: Using <code>--no-verify</code></span><br><br>
...
<div style="background:#EBF5F0;border-left:5px solid #009E73;padding:14px 18px;border-radius:6px;margin:16px 0">
<span style="color:#065F46;font-weight:bold"><i class="bi bi-puzzle-fill"></i> Capstone - Zero Findings</span><br><br>
<ol>
...
<pre style='background:#FFF8E1;padding:10px;border-radius:4px;font-size:0.9em'>uv run pre-commit run --all-files
