...
Part 16 (`04-git-github.qmd`) versioned the `grade-predictor` project. This chapter writes tests for it using pytest. Part 18 (`06-pre-commit-automation.qmd`) will run those tests automatically before every commit.
