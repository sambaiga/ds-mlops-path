...
![VS Code download page showing macOS, Windows, and Linux options](https://code.visualstudio.com/assets/docs/getstarted/getting-started/getting-started-download.png)

> Source: [VS Code Getting Started](https://code.visualstudio.com/docs/getstarted/getting-started)
...
![VS Code interface: Activity Bar, Side Bar, Editor, Panel, Status Bar](https://code.visualstudio.com/assets/docs/getstarted/userinterface/hero.png)
...
![Selecting the Python interpreter in VS Code's Status Bar](https://code.visualstudio.com/assets/docs/python/environments/interpreters-list.png)
...
![VS Code Jupyter notebook with Variable Inspector open](https://code.visualstudio.com/assets/docs/datascience/jupyter/variable-inspector.png)
...
![VS Code Source Control panel showing staged and unstaged changes](https://code.visualstudio.com/assets/docs/sourcecontrol/overview/scm-view.png)
